...
class _EditProductFormState extends State<EditProductForm> {
  ...
  Future<void> saveProductButtonCallback(BuildContext context) async {
    ...
    List<String?> downloadUrls = productDetails.selectedImages
        ...
        .toList();
    List<String> validDownloadUrls = downloadUrls.where((url) => url != null).cast<String>().toList();
    bool productFinalizeUpdate = false;
    try {
      final updateProductFuture = ProductDatabaseHelper().updateProductsImages(productId!, validDownloadUrls);
