import 'package:e_shopee/screens/product_details/provider_models/ExpandText.dart';
      ...
      child: Consumer<ExpandText>(builder: (context, expandText, child) {
        return Column(
          ...
          children: [
            Text(
              title,
              style: josefinBold.copyWith(color: kBlackColor),
            ),
            Divider(
              height: 8,
              thickness: 1,
                ...
                children: [
                  Text(
                    expandText.isExpanded == false
                        ? "See more details"
                        : "Show less details",
                    style: josefinBold.copyWith(color: kPrimaryColor,fontSize: Dimensions.fontSizeSmall),
                  ),
