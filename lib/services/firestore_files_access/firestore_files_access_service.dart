...
class FirestoreFilesAccess {
  ...
  factory FirestoreFilesAccess() => _instance;
  ...
  Future<bool> deleteFileByUrl(String imageUrl) async {
    try {
      if (imageUrl.isNotEmpty) {
        final Reference firestorageRef =
        FirebaseStorage.instance.refFromURL(imageUrl);
        await firestorageRef.delete();
        return true;
      }
    } catch (e) {
  ...
  Future<String> getDeveloperImage() async {
    ...
    List<String> extensions = <String>["jpg", "jpeg", "png", "jfif"];
    final Reference firestorageRef = FirebaseStorage.instance.ref();
